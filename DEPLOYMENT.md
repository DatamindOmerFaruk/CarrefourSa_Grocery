...
0 8 * * * cd /opt/carrefoursa-kamera && /opt/carrefoursa-kamera/venv/bin/python /opt/carrefoursa-kamera/multi_camera_system/camera_snapshot_system.py >> /opt/carrefoursa-kamera/logs/cron-snapshot.log 2>&1

# Örnek: Her saat başı snapshot al
0 * * * * cd /opt/carrefoursa-kamera && /opt/carrefoursa-kamera/venv/bin/python /opt/carrefoursa-kamera/multi_camera_system/camera_snapshot_system.py >> /opt/carrefoursa-kamera/logs/cron-snapshot.log 2>&1
```
